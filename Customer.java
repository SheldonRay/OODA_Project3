...
abstract public class Customer {
    ...
    public static void rollChoice(customer person) {//populate array with rolls based on what customer "wants"
        ...
        for (int i = 0; i < person.rollArray.length; i++){
            sauceChoice = RandSauceChoice();
            person.sauceArray[i] = sauceChoice;
            fillChoice = RandFillChoice();
            person.fillArray[i] = fillChoice;
            topChoice = RandTopChoice();
            person.topArray[i] = topChoice;
        }
